...
<!-- component -->
<section class="px-4 mx-auto mb-12 bg-black max-w-7xl sm:px-6 lg:px-4">
    <article>
        <section class="grid grid-cols-1 mt-6 bg-black md:grid-cols-1 lg:grid-cols-3 gap-x-6 gap-y-8 card-section">
